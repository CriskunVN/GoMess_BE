...
class AppError extends Error {
  public statusCode: number; // Mã trạng thái HTTP (404, 500, ...)
  public status: string; // "fail" hoặc "error"
  public isOperational: boolean; // Đánh dấu lỗi có thể dự đoán/kiểm soát
